...
class Provider(BaseProvider):
    faculty_departments = ['Acil Yardım ve Afet Yönetimi', 'Adli Bilişim Mühendisliği',
                           ...
                           'Arapça Öğretmenliği', 'Arkeoloji', 'Arnavut Dili ve Edebiyatı',
                           ...
                           'Bankacılık ve Sigortacılık', 'Basım Yayın Üretim Teknolojileri',
                           ...
                           'Deniz Ulaştırma İşletme Mühendisliği', 'Denizcilik İşletmeleri Yönetimi',
                           'Deri Mühendisliği',
                           ...
                           'Ergoterapi', 'Ermeni Dili ve Edebiyatı', 'Eşit Ağırlıklı Programlar',
                           'Fars Dili ve Edebiyatı',
                           'Felsefe', 'Felsefe Grubu Öğretmenliği', 'Fen Bilgisi Öğretmenliği', 'Film Tasarımı',
                           'Fizik',
                           'Fizik Mühendisliği', 'Fizik Öğretmenliği', 'Fizyoterapi ve Rehabilitasyon',
                           'Fotoğraf ve Video',
                           ...
                           'Geomatik Mühendisliği', 'Gerontoloji', 'Gıda Mühendisliği', 'Gıda Teknolojisi',
                           'Girişimcilik',
                           'Görme Engelliler Öğretmenliği', 'Görsel İletişim Tasarımı', 'Görsel Sanatlar',
                           'Grafik Tasarımı',
                           ...
                           'Havacılık Elektrik ve Elektroniği', 'Havacılık İşletmeciliği',
                           ...
                           'İngiliz Dili ve Edebiyatı', 'İngiliz Dili ve Karşılaştırmalı Edebiyat',
                           'İngilizce Öğretmenliği',
                           'İnsan Kaynakları Yönetimi', 'İnsan ve Toplum Bilimleri', 'İnşaat Mühendisliği',
                           'İslami İlimler',
                           ...
                           'İşletme Yönetimi', 'İşletme Ekonomi', 'İtalyan Dili ve Edebiyatı',
                           ...
                           'Kentsel Tasarım ve Peyzaj Mimarisi', 'Kimya', 'Kimya Mühendisliği',
                           'Kimya ve Süreç Mühendisliği',
                           'Kimya Biyoloji Mühendisliği', 'Kimya Öğretmenliği', 'Klasik Arkeoloji',
                           'Konaklama İşletmeciliği',
                           'Kontrol ve Otomasyon Mühendisliği', 'Kore Dili ve Edebiyatı',
                           'Kurgu-Ses ve Görüntü Yönetimi',
                           'Kuyumculuk ve Mücevher Tasarımı', 'Kültür Varlıklarını Koruma ve Onarım',
                           'Kürt Dili ve Edebiyatı',
                           'Latin Dili ve Edebiyatı', 'Leh Dili ve Edebiyatı', 'Lojistik Yönetimi',
                           'Maden Mühendisliği',
                           ...
                           'Matematik – Bilgisayar', 'Matematik Öğretmenliği', 'Medya ve İletişim',
                           ...
                           'Mühendislik ve Doğa Bilimleri Programları', 'Mühendislik Programları',
                           'Mütercim Tercümanlık',
                           'Müzecilik', 'Nükleer Enerji Mühendisliği', 'Odyoloji', 'Okul Öncesi Öğretmenliği',
                           'Optik ve Akustik Mühendisliği', 'Organik Tarım İşletmeciliği',
                           ...
                           'Sosyoloji', 'Spor Yöneticiliği', 'Su Ürünleri Mühendisliği', 'Sümeroloji',
                           'Süt Teknolojisi',
                           ...
                           'Turizm Rehberliği', 'Turizm ve Otel İşletmeciliği', 'Türk Dili ve Edebiyatı',
                           'Türk Halkbilimi',
                           ...
                           'Uluslararası Girişimcilik', 'Uluslararası İlişkiler',
                           ...
                           'Üstün Zekalılar Öğretmenliği', 'Veterinerlik Fakültesi',
