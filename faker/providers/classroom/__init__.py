...
class Provider(BaseProvider):
    classrooms = ('A101', 'A102', 'A103', 'A104', 'A105', 'A106', 'A107', 'A108', 'A109', 'A110',
    ...
    classroom_types = ('Bilgisayar Laboratuarları', 'CAD Laboratuarları', 'Dikim Atölyesi', 'Elektronik Laboratuarı',
                       ...
                       'Mikroişlemci Laboratuarı', 'Moda Tasarım Stüdyosu', 'Mütercim Tercümanlık Laboratuarı', 'Psikoloji Laboratuarları',
                       'Radyo Stüdyosu', 'Resim Atölyesi', 'Smart Class (Akıllı Sınıf)', 'Silent Study Kişisel Erişim Merkezi', 'Video-Audio G Kişisel Erişim Merkezi',
                       'Self Access Center', 'Simülasyon Laboratuarı', 'Tasarım Stüdyoları', 'Tekstil Arşivi', 'Tekstil Baskı Atölyesi')
    )